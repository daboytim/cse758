...
//		    p.setRowHeight(h);
	...
	private void initData(Object[][] data) {
		...
		if (std.getHomeroomCls() == null)
			...
			data[3][1] = std.getHomeroomCls().getTeacher().getRoom();
		...
		if (std.getReadCls() == null)
			...
			data[4][1] = std.getReadCls().getTeacher().getRoom();
		...
		if (std.getLACls() == null)
			...
			data[5][1] = std.getLACls().getTeacher().getRoom();
		...
		if (std.getMathCls() == null)
			...
			data[6][1] = std.getMathCls().getTeacher().getRoom();
		...
		if (std.getSpecialCls() == null)
			...
			data[7][1] = std.getSpecialCls().getTeacher().getRoom();
	}
